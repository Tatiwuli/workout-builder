...
user_prompts_dict = {
    ...
    "tier_list": {
        ...
        "main_knowledge_prompt": Template("""
                    ...
                    2. **Ranking Criteria**: 
                        - "[Criterion 1]": "[Briefly explain what does the video mean by that]",
                        - "[Criterion 2]": "[Briefly explain what does the video mean by that]",
                        - "[Criterion 3]": "[Briefly explain what does the video mean by that]"
